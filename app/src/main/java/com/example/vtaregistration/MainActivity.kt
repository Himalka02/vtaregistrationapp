package com.example.vtaregistration
...
class MainActivity : AppCompatActivity() {
    ...
    private fun submitStudentDetails() {
        ...
        if (studentName.isNotEmpty() && studentId.isNotEmpty() && studentMobile.isNotEmpty() &&
            ...
            val teacherMessage = "Student: $studentName (ID: $studentId, Mobile: $studentMobile) has applied for $selectedCourse. Ref number: $refNumber."
